...
/// @notice Defines methods for versions.
library Versioning {
    ...
    function encode(
        ...
        /// @dev encodePacked will pack 64+64+128 bits into one 32-byte string.
        return
            EncodedVersion.wrap(
                bytes32(abi.encodePacked(version.major, version.minor, version.patch))
            );
    }
}
